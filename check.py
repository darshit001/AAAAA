...
import olefile
from pdf2image import convert_from_path  # Import for extracting images from PDFs
import easyocr  # Import EasyOCR for text extraction from images
import numpy as np
...
def extract_text_from_pdf(pdf_path):
    ...
    for page_num in range(len(pdf_reader.pages)):
        ...
        if page_text:
            print(f"Page {page_num + 1} contains an text. Using OCR...")
            text += page_text
        else:
            print(f"Page {page_num + 1} contains an image. Using OCR...")
